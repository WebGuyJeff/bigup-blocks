...
/*!********************************************************!*\
  !*** ./src/blocks/mortgage-calc/mortgage-calc-view.js ***!
  \********************************************************/
/**
...
const calculate = () => {
  ...
  document.getElementById("mortgageCalc_results-total").innerHTML = document.getElementById("languageString_monthlyRepaymentLabel").innerHTML + " <span>&pound;" + formatPrice(monthlyRepayment.toFixed(2)) + "</span>";
  document.getElementById("mortgageCalc_results-interest-paid").innerHTML = document.getElementById("languageString_totalInterestPaidLabel").innerHTML + " <span>&pound;" + formatPrice(totalInterestPaid.toFixed(2)) + "</span>";
